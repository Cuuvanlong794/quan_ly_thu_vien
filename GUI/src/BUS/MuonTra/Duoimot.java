...
import java.sql.Connection; // Sử dụng lớp kết nối từ java.sql
...
public class Duoimot extends loc_funtion {

    public Duoimot(DefaultTableModel tableModel) {
        super(tableModel);
    }
        ...
        try (Connection connection = connect.getConnection()) {
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
                ...
                while (resultSet.next()) {
                    ...
                    // Thêm dữ liệu vào tableModel nếu số ngày mượn dưới 1
                    if (soNgay < 1) {
